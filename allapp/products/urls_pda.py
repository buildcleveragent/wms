...
urlpatterns = [
    path(
        "identifier-maintenance-template/",
        ProductIdentifierTemplateApi.as_view(),
        name="identifier-template",
    ),
    path(
        "identifier-maintenance-export/",
        ProductIdentifierExportApi.as_view(),
        name="identifier-export",
    ),
    path(
        "identifier-maintenance-import/",
        ProductIdentifierImportApi.as_view(),
