...
ROLE_GROUP_TEMPLATES = {
    UserRoleScope.Role.WAREHOUSE_OPERATOR: RoleGroupTemplate(
        ...
        permissions=(
            ...
            "tasking.request_replenishment",
            "tasking.request_relocation",
    ...
    UserRoleScope.Role.WAREHOUSE_MANAGER: RoleGroupTemplate(
        ...
        permissions=(
            ...
            "tasking.manage_replenishment_policy",
            "tasking.evaluate_replenishment",
            "tasking.approve_replenishment",
            "tasking.approve_relocation",
            "tasking.manage_relocation",
