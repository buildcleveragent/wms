...
class LabelTemplate(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            CheckConstraint(
                condition=Q(width_mm__gt=0) & Q(height_mm__gt=0), name="chk_tpl_size_gt0"
            ),
        ]
        indexes = [
...
class PrintJob(models.Model):
    ...
    printer = models.ForeignKey(
        Printer, on_delete=models.PROTECT, related_name="print_jobs", null=True, blank=True
    )
    ...
    class Meta:
        ...
        constraints = [
            CheckConstraint(condition=Q(copies__gte=1), name="chk_job_copies_ge1"),
        ]
        indexes = [
