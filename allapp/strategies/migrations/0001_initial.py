...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, null=True, verbose_name="策略类别描述"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "target",
                    models.CharField(
                        max_length=255, verbose_name="目标对象（如订单、库存、配送等）"
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="策略失效时间"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.AddIndex(
            model_name="strategy",
            index=models.Index(
                fields=["name", "template"], name="strategies__name_e7d857_idx"
            ),
        ),
    ]
